...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarContent">
    ...
    <form class="form-inline my-2 my-lg-0 mx-3" method="post" action="<@ofbizUrl>keywordsearch</@ofbizUrl>">
      <input class="form-control mr-sm-2 search-input" type="search" name="SEARCH_STRING" placeholder="${uiLabelMap.CommonSearch!"Search"}" aria-label="Search" />
      <button class="btn btn-outline-light my-2 my-sm-0" type="submit">${uiLabelMap.CommonFind!"Find"}</button>
    </form>
